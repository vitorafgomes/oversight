...
public class OtlpEndpointConfiguredTests
{
    ...
    public void Reports_unconfigured_when_no_endpoint_variable_is_set() =>
        OversightStartupDiagnostics.OtlpEndpointConfigured(static _ => null).ShouldBeFalse();

    [Fact]
    public void Reports_configured_when_the_generic_endpoint_is_set() =>
        OversightStartupDiagnostics.OtlpEndpointConfigured(
...
public class OversightStartupDiagnosticsTests
{
    [Fact]
    public async Task Warns_when_no_otlp_endpoint_is_configured()
    {
        ...
        var logger = new FakeLogger<OversightStartupDiagnostics>();
        var diagnostics = new OversightStartupDiagnostics(logger);
