...
internal sealed class FarolStartupDiagnostics(ILogger<FarolStartupDiagnostics> logger) : IHostedService
{
    ...
    public Task StartAsync(CancellationToken cancellationToken)
    {
        ...
        {
            logger.LogWarning(
                "Farol: telemetry has no destination. No OTLP endpoint is configured "
